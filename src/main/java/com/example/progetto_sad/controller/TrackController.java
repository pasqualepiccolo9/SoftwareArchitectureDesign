...
public class TrackController {
     ...
     * La traccia conosce le proprie playlist (vedi {@link Track#getPlaylists()}): si itera
     * su quella copia perche' {@link Playlist#removeTrack(Track)} aggiorna (svuota) la lista
     * interna della traccia mentre procede.
     *
